#!/usr/bin/env python3
"""
DPI-Evading Transparent Proxy Daemon - Исправленная версия
...
class IntegratedProxyDaemon:
    ...
    def __init__(self, listen_port=1080, chunk_size=30, chunk_delay=0.005):
        ...
        self.logger.info(f"Fixed proxy daemon initialized: port={listen_port}, chunk_size={chunk_size}, chunk_delay={chunk_delay}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='DPI-Evading Fixed Transparent Proxy Daemon')
