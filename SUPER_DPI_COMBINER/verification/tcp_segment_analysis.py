#!/usr/bin/env python3
"""
TCP Segment Analysis - Анализ TCP сегментов для доказательства wire fragmentation
"""
...
class TCPSegmentAnalyzer:
                ...
                if analysis:
                    for conn_key, conn_analysis in analysis.items():
                        ...
                        if conn_analysis['has_fragmentation']:
                            ...
                            print(f"    Inter-segment delays: {[d*1000:.2f for d in conn_analysis['inter_segment_delays']]}ms")
    ...
    def generate_final_report(self):
        ...
        import json
        with open("TCP_SEGMENT_ANALYSIS.json", "w") as f:
            json.dump(self.analysis_results, f, indent=2)
        
        print(f"📄 Results saved to: TCP_SEGMENT_ANALYSIS.json")
