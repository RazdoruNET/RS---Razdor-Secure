#!/usr/bin/env python3
"""
TCP Segment Analysis - Анализ TCP сегментов для доказательства wire fragmentation (финальная версия)
"""
...
class TCPSegmentAnalyzer:
                ...
                if analysis:
                    for conn_key, conn_analysis in analysis.items():
                        ...
                        if conn_analysis['has_fragmentation']:
                            ...
                            delays_ms = [round(float(d)*1000, 2) for d in delays]
                            print(f"    Inter-segment delays: {delays_ms}ms")
    ...
    def generate_final_report(self):
        ...
        import json
        with open("TCP_SEGMENT_ANALYSIS_FINAL.json", "w") as f:
            json.dump(self.analysis_results, f, indent=2)
        
        print(f"📄 Results saved to: TCP_SEGMENT_ANALYSIS_FINAL.json")
