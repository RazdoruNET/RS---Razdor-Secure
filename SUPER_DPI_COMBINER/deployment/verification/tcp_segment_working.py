#!/usr/bin/env python3
"""
TCP Segment Analysis - Рабочая версия с исправленным синтаксисом
"""
...
class TCPSegmentAnalyzer:
    ...
    def generate_final_report(self):
        ...
        import json
        with open("TCP_SEGMENT_ANALYSIS_WORKING.json", "w") as f:
            json.dump(self.analysis_results, f, indent=2)
        
        print(f"📄 Results saved to: TCP_SEGMENT_ANALYSIS_WORKING.json")
