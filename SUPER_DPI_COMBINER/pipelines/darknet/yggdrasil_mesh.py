...
class YggdrasilMeshPipeline(SafePipeline):
    """Пайплайн для Mesh сети Yggdrasil"""
    
    def __init__(self):
        super().__init__("YggdrasilMesh", BypassTechnique.TOR_INTEGRATION, priority=12, execution_status=PipelineExecutionStatus.SIMULATION)
