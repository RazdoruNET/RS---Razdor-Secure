...
1. **Сетевой анализатор** - анализ сетевого трафика с 1D свертками
2. **Анализатор процессов** - анализ поведения процессов с LSTM и attention
3. **Анализатор файлов** - анализ файловой активности с residual connections
4. **Системный анализатор** - анализ системного состояния с dilated convolutions
5. **Ансамблевая модель** - мета-learner для объединения результатов
