...
Этот гид предоставляет подробные инструкции по безопасному тестированию RSecure системы на себе. Важно соблюдать все меры предосторожности для избежания вреда здоровью.
...
```yaml
Не рекомендуется тестировать при:
  - Эпилепсии или судорожных расстройствах
  - Сердечных заболеваниях (аритмия, пейсмекер)
  - Психических расстройствах (шизофрения, депрессия)
  - Беременности
  - Детском возрасте (< 18 лет)
  - Приеме нейролептиков или антидепрессантов
...
Ограничения мощности:
  - Максимальная мощность излучения: 1W
...
### Шаг 1: Медицинская подготовка
```python
# medical_checklist.py
import json
